...
vim.cmd[[autocmd CursorMoved,InsertLeave,BufEnter,BufWinEnter,TabEnter,BufWritePost *.rs lua require'lsp_extensions'.inlay_hints{ prefix = '', highlight = "TSComment", enabled = {"TypeHint", "ChainingHint", "ParameterHint"} }]]
