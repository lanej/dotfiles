...
- **Skill anatomy and progressive disclosure**: See [references/design.md](references/design.md) for structure guidance, when to use scripts vs. references vs. assets, and patterns for keeping SKILL.md lean
