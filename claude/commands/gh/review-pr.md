...
5. **Use the pull-request-commentor agent** to generate professional review comments:
    ...
    - Ensure comments are actionable and respectful
    - NEVER add AI attribution or "Generated by" footers
6. If posting comments, USE Bash(`gh api repos/OWNER/REPO/pulls/PR_NUMBER/comments`)
