...
- Include a screenshot when it helps reviewers assess a visual change. Omit
  it when the diff and prose are sufficient. When included, show the actual
...
when useful. A short description does not need headings. Do not reproduce
...
that any included images actually load.
